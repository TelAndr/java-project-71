...
public class YamlDrivenTest {
    ...
    public void testYamlDrivenScenario() throws Exception {
        ...
        String strJsonPath1 = "src/main/resources/file1.json";
        String strJsonPath2 = "src/main/resources/file2.json";
        String fileContent1 = Files.readString(Path.of(strJsonPath1));
        String fileContent2 = Files.readString(Path.of(strJsonPath2));
        String strFileType1 = "json";
        String strFileType2 = "json";
        String expectedStrVal = "not identical";
        //String strResult = compareJsonFiles(testCase.inputFile1, testCase.inputFile2);
        String strResult = compareJsonFiles(fileContent1, fileContent2);
        // Проверка результата
        assertEquals(expectedStrVal, strResult);
    ...
    private String compareJsonFiles(String file1, String file2) throws IOException {
        ...
        Map<String, Object> json1 = objMapper.readValue(file1, Map.class);
        Map<String, Object> json2 = objMapper.readValue(file2, Map.class);
